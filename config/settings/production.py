...
ALLOWED_HOSTS = env.list(
    "DJANGO_ALLOWED_HOSTS", default=["net153.net", "www.net153.net"]
)
...
# remove when django is at the root of site
#FORCE_SCRIPT_NAME = '/d'
#STATIC_URL = "/d/static/"
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="net153 <noreply@net153.net>",
)
...
EMAIL_SUBJECT_PREFIX = env(
    "DJANGO_EMAIL_SUBJECT_PREFIX", default="[net153]"
)

...
DATABASES = {
    ...
    "default": env.db(
        "DATABASE_URL",
        default="postgres://net153:maaN8qui@localhost/net153",
    )
}
...
LOCAL_APPS = [
    "net153.users.apps.UsersConfig",
    # Your stuff: custom apps go here
    "net153.blog.apps.BlogConfig",
    "net153.journal.apps.JournalConfig",
]
...
MIGRATION_MODULES = {
    "sites": "net153.contrib.sites.migrations"
}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "net153.utils.context_processors.settings_context",
            ],
        },
    }
]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "net153.users.adapters.AccountAdapter"
# Your stuff...
# ------------------------------------------------------------------------------
MARKDOWNIFY = {
    "default": {
